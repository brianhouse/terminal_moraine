...
, 			{
				"box" : 				{
					...
					"offset" : 1,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 285.0, 158.0, 136.0, 136.0 ],
					"point_size" : 4.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 126.0, 93.0, 22.0 ],
					"text" : "xyz $1 $5 $6 $7"
				}
...
, 			{
				"box" : 				{
					...
					"orientation" : 2,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 67.0, 231.0, 210.0, 63.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "limb.maxpat",
				"bootpath" : "~/localdev/bbg/terminal_moraine/poly_tree_max",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
