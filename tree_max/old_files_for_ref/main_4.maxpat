...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 189.0, 749.5, 84.0, 22.0 ],
					"text" : "mc.unpack~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 491.0, 701.0, 92.0, 22.0 ],
					"text" : "mc.mixdown~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 314.0, 648.0, 92.5, 22.0 ],
					"text" : "mc.pack~ 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 189.0, 715.0, 92.0, 22.0 ],
					"text" : "mc.mixdown~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 367.0, 756.0, 337.0, 22.0 ],
					"text" : "mc.pack~ 9"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -34.5, 633.0, 50.0, 22.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 149.0, 130.0, 90.0, 22.0 ],
									"text" : "xyz 2 0.75 0. 0."
								}
...
,
					"patching_rect" : [ 516.0, 218.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 139.0, 195.0, 51.0, 22.0 ],
					"text" : "phrases"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -23.5, 582.0, 83.0, 22.0 ],
					"text" : "loadmess 100"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 29.5, 536.0, 681.18181818181813, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 738.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 126.0, 644.0, 12.0, 58.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 108.0, 644.0, 12.0, 58.0 ]
				}
