...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 520.0, 394.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 542.0, 451.0, 90.0, 22.0 ],
					"text" : "xyz 2 0.75 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 424.0, 94.0, 22.0 ],
					"text" : "xyz 1 -0.75 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 390.0, 465.0, 150.0, 150.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 480.0, 344.5, 22.0 ],
					"text" : "mc.unpack~ 32"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 513.0, 344.5, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 630.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 200.0, 630.0, 12.0, 58.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 182.0, 630.0, 12.0, 58.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "limb.maxpat",
				"bootpath" : "~/Studio/terminal_morraine/code/poly_tree_max",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
